        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
          ...
          <div className="text-black space-y-6 text-lg leading-relaxed animate-slideInLeft">
            <p>
              ...
              purposeful architecture, and the presence of compassionate caregivers,
              it empowers residents to lead independent, fulfilled lives.
            </p>
            <p>
              Born from the dreams of parents supporting the Team Titans — a
              wheelchair sports team in Metro Atlanta — Champions Place brings a
              bold vision to life: a future where differently-abled athletes thrive
              in a nurturing community.
            </p>
            <p>
              This website honors their journey, the memory of Garett Couch, and the
              powerful partnership between Champions Place and Innovation Academy.
